 ...
 * @return 0 if match, 1 if not match (no magnitude comparison)
 */
...
/**
 * Copy string ct to string s (strlcpy ?)
 * s is always terminated by '\0' and s is no longer than n-1 characters long.
 * Extra space is not padded with \0.
 * Returns: none
 * @param s
 * @param ct
 * @param n
...
/**
 * Concatenate string ct to string s (strlcat ?)
 * s is always terminated by '\0' and s is no longer than n-1 characters long.
 * @param s
 * @param ct
 * @param n
