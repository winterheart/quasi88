...
#define M_BIT(bit, reg)                                                                                                \
  do {                                                                                                                 \
    z80->FLAG = (z80->FLAG & ~(Z_FLAG | N_FLAG | S_FLAG)) | H_FLAG |                                                   \
                ((reg & (1 << bit)) ? ((bit == 7) ? S_FLAG : 0) : Z_FLAG);                                             \
  } while (0)

#define M_SET(bit, reg)                                                                                                \
  do {                                                                                                                 \
    reg |= 1 << bit;                                                                                                   \
  } while (0)
#define M_RES(bit, reg)                                                                                                \
  do {                                                                                                                 \
    reg &= ~(1 << bit);                                                                                                \
  } while (0)
...
#define M_ADD_A(reg)                                                                                                   \
  do {                                                                                                                 \
    J.W = z80->ACC + reg;                                                                                              \
    z80->FLAG = SZ_table[J.B.l] | ((z80->ACC ^ reg ^ J.B.l) & H_FLAG) |                                                \
                (~(z80->ACC ^ reg) & (reg ^ J.B.l) & 0x80 ? V_FLAG : 0) | J.B.h;                                       \
    z80->ACC = J.B.l;                                                                                                  \
  } while (0)
#define M_ADC_A(reg)                                                                                                   \
  do {                                                                                                                 \
...
#define M_SUB(reg)                                                                                                     \
  do {                                                                                                                 \
    J.W = z80->ACC - reg;                                                                                              \
    z80->FLAG = SZ_table[J.B.l] | ((z80->ACC ^ reg ^ J.B.l) & H_FLAG) |                                                \
                ((z80->ACC ^ reg) & (z80->ACC ^ J.B.l) & 0x80 ? V_FLAG : 0) | N_FLAG | -J.B.h;                         \
    z80->ACC = J.B.l;                                                                                                  \
  } while (0)
#define M_SBC_A(reg)                                                                                                   \
  do {                                                                                                                 \
...
#define M_INC(reg)                                                                                                     \
  do {                                                                                                                 \
    reg++;                                                                                                             \
    z80->FLAG = SZ_table[reg] | (reg & 0x0f ? 0 : H_FLAG) | (reg == 0x80 ? V_FLAG : 0) | (z80->FLAG & C_FLAG);         \
  } while (0)
#define M_DEC(reg)                                                                                                     \
  do {                                                                                                                 \
    reg--;                                                                                                             \
    z80->FLAG = SZ_table[reg] | ((reg & 0x0f) == 0x0f ? H_FLAG : 0) | (reg == 0x7f ? V_FLAG : 0) | N_FLAG |            \
                (z80->FLAG & C_FLAG);                                                                                  \
  } while (0)
...
#define M_ADDW(reg1, reg2)                                                                                             \
  do {                                                                                                                 \
    ...
    z80->FLAG = (z80->FLAG & ~(H_FLAG | N_FLAG | C_FLAG)) | ((reg1 ^ reg2 ^ J.W) & 0x1000 ? H_FLAG : 0) |              \
...
#define M_ADCW(reg)                                                                                                    \
  do {                                                                                                                 \
    ...
    z80->FLAG = (J.B.h & S_FLAG) | (J.W ? 0 : Z_FLAG) | ((z80->HL.W ^ reg ^ J.W) & 0x1000 ? H_FLAG : 0) |              \
...
#define M_SBCW(reg)                                                                                                    \
  do {                                                                                                                 \
    ...
    J.W = (z80->HL.W - reg - I) & 0xffff;                                                                              \
    z80->FLAG = (J.B.h & S_FLAG) | (J.W ? 0 : Z_FLAG) | ((z80->HL.W ^ reg ^ J.W) & 0x1000 ? H_FLAG : 0) |              \
                ((z80->HL.W ^ reg) & (z80->HL.W ^ J.W) & 0x8000 ? V_FLAG : 0) | N_FLAG |                               \
                (((long)z80->HL.W - (long)reg - (long)I) & 0x10000 ? C_FLAG : 0);                                      \
    z80->HL.W = J.W;                                                                                                   \
  } while (0)
