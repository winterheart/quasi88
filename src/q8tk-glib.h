...
void q8gr_draw_option_menu(int x, int y, int sx, int sy, int button, void *p);
void q8gr_draw_radio_menu_item(int x, int y, int width, int underline, int code, const char *text, void *p);
