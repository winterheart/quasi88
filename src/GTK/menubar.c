...
typedef struct {
  enum { TP_SUB, TP_ITEM, TP_CHECK, TP_RADIO, TP_SEP } type;
  int id;
  const char *label;
  int parent;
  int group;
...
static T_MENUTABLE menutable[] = {
    ...
    {TP_RADIO, M_SYS_MODE_V2, "V2", M_SYS_MODE, GRP_BASIC, f_sys_basic,
     BASIC_V2},
    {TP_RADIO, M_SYS_MODE_V1H, "V1H", M_SYS_MODE, GRP_BASIC, f_sys_basic,
     BASIC_V1H},
    {TP_RADIO, M_SYS_MODE_V1S, "V1S", M_SYS_MODE, GRP_BASIC, f_sys_basic,
     BASIC_V1S},
    {TP_RADIO, M_SYS_MODE_N, "N", M_SYS_MODE, GRP_BASIC, f_sys_basic, BASIC_N},
    {TP_SEP, 0, 0, M_SYS_MODE, 0, 0, 0},
    {TP_RADIO, M_SYS_MODE_4MH, "4MHz", M_SYS_MODE, GRP_CLOCK, f_sys_clock,
     CLOCK_4MHZ},
    {TP_RADIO, M_SYS_MODE_8MH, "8MHz", M_SYS_MODE, GRP_CLOCK, f_sys_clock,
     CLOCK_8MHZ},
    {TP_SEP, 0, 0, M_SYS_MODE, 0, 0, 0},
    {TP_RADIO, M_SYS_MODE_SB, "Sound Board", M_SYS_MODE, GRP_SB, f_sys_sb,
     SOUND_I},
    {TP_RADIO, M_SYS_MODE_SB2, "Sound Board II", M_SYS_MODE, GRP_SB, f_sys_sb,
     SOUND_II},
    ...
    {TP_RADIO, M_SET_SUB_SOME, "Run sometimes", M_SET_SUB, GRP_SUBCPU,
     f_set_subcpu, 0},
    {TP_RADIO, M_SET_SUB_OFT, "Run often", M_SET_SUB, GRP_SUBCPU, f_set_subcpu,
     1},
    {TP_RADIO, M_SET_SUB_ALL, "Run always", M_SET_SUB, GRP_SUBCPU, f_set_subcpu,
     2},
    ...
    {TP_RADIO, M_SET_INT_NO, "Non interlace", M_SET_INT, GRP_INTERLACE,
     f_set_interlace, SCREEN_INTERLACE_NO},
    {TP_RADIO, M_SET_INT_SKIP, "Skip Line", M_SET_INT, GRP_INTERLACE,
     f_set_interlace, SCREEN_INTERLACE_SKIP},
    {TP_RADIO, M_SET_INT_YES, "Interlace", M_SET_INT, GRP_INTERLACE,
     f_set_interlace, SCREEN_INTERLACE_YES},

    {TP_SUB, M_SET_SIZ, "Screen Size", M_SET, 0, 0, 0},
    {TP_RADIO, M_SET_SIZ_DUMMY, 0, M_SET_SIZ, GRP_SIZE, 0, 0},
#ifdef SUPPORT_DOUBLE
    {TP_RADIO, M_SET_SIZ_DOUBLE, "Double size", M_SET_SIZ, GRP_SIZE, f_set_size,
     SCREEN_SIZE_DOUBLE},
#endif
    {TP_RADIO, M_SET_SIZ_FULL, "Normal size", M_SET_SIZ, GRP_SIZE, f_set_size,
     SCREEN_SIZE_FULL},
    {TP_RADIO, M_SET_SIZ_HALF, "Half size", M_SET_SIZ, GRP_SIZE, f_set_size,
     SCREEN_SIZE_HALF},
    ...
    {TP_RADIO, M_SET_MO_NO, "Nothing", M_SET_MO, GRP_MOUSE, f_set_mouse,
     MOUSE_NONE},
    {TP_RADIO, M_SET_MO_MOUSE, "Mouse", M_SET_MO, GRP_MOUSE, f_set_mouse,
     MOUSE_MOUSE},
    {TP_RADIO, M_SET_MO_JOYMO, "Mouse as joy", M_SET_MO, GRP_MOUSE, f_set_mouse,
     MOUSE_JOYMOUSE},
    /*  { TP_RADIO, M_SET_MO_JOY,   "Joystick",     M_SET_MO,   GRP_MOUSE,
       f_set_mouse,    MOUSE_JOYSTICK  },*/

    {TP_SUB, M_SET_CUR, "Cursor Key", M_SET, 0, 0, 0},
    {TP_RADIO, M_SET_CUR_DUMMY, 0, M_SET_CUR, GRP_CURSOR, 0, 0},
    {TP_RADIO, M_SET_CUR_DEF, "Default", M_SET_CUR, GRP_CURSOR, f_set_cursor,
     0},
    {TP_RADIO, M_SET_CUR_TEN, "as Ten-key", M_SET_CUR, GRP_CURSOR, f_set_cursor,
     1},
    ...
    {TP_RADIO, M_DRV_DRV1_NO, "<No disk>", M_DRV_DRV1, GRP_DRIVE1, f_drv_drv1,
     -1},
    ...
    {TP_RADIO, M_DRV_DRV2_NO, "<No disk>", M_DRV_DRV2, GRP_DRIVE2, f_drv_drv2,
     -1},
    ...
    {TP_RADIO, M_MISC_CLOAD_S, "Set ...", M_MISC_CLOAD, GRP_CLOAD,
     f_misc_cload_s, 0},
    ...
    {TP_RADIO, M_MISC_CSAVE_S, "Set ...", M_MISC_CSAVE, GRP_CSAVE,
     f_misc_csave_s, 0},
 ...
 * メニューバー生成
 ************************************************************************/
void create_menubar(GtkWidget *target_window, GtkWidget **created_menubar) {
  int i, show;
...
static void update_drive(void) {
  ...
  for (drv = 0; drv < NR_DRIVE; drv++) {
    ...
    gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(mwidget[uItem].widget),
                                   TRUE);
  }
...
static void update_misc_record(void) {
  ...
  uItem = M_MISC_RECORD;
  gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(mwidget[uItem].widget), i);
...
static void f_sys_menu(GtkMenuItem *widget, gpointer data) { quasi88_menu(); }

static void f_sys_save(GtkMenuItem *widget, gpointer data) {
  config_save(NULL);
}

static void f_sys_exit(GtkMenuItem *widget, gpointer data) { quasi88_quit(); }
...
static void f_drv_chg(GtkMenuItem *widget, gpointer data) {
  ...
  select_file(headline, cb_drv_chg, menubar_filename, sizeof(menubar_filename));
...
static void f_misc_cload_s(GtkMenuItem *widget, gpointer data) {
  ...
  select_file("Open Tape-Image-File for LOAD", cb_misc_cload_s,
              menubar_filename, sizeof(menubar_filename));
...
static void f_misc_csave_s(GtkMenuItem *widget, gpointer data) {
  ...
  select_file("Open Tape-Image-File for SAVE (append)", cb_misc_csave_s,
              menubar_filename, sizeof(menubar_filename));
