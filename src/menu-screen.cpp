...
/*----------------------------------------------------------------------*/
#if 0 /* 矢印カーソル */
uint8_t menu_cursor_on[]  = { 0x80, 0xc0, 0xe0, 0xf0, 0xf8, 0xfc, 0xfe, 0xff,
               0xd8, 0xa8, 0x0c, 0x0c, 0x06, 0x06, 0x03, 0x03 };
#else /* ブロックカーソル */
uint8_t menu_cursor_on[] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
                         0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
#endif

uint8_t menu_cursor_off[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
