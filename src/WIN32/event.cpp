 ...
 * これは 起動時に1回だけ呼ばれる
 */
void event_init(void) { memcpy(keysym2key88, keysym2key88_default, sizeof(keysym2key88_default)); }
...
void event_update(void) {
  ...
  while (PeekMessage(&msg, NULL, 0, 0, PM_NOREMOVE)) {
    if (GetMessage(&msg, NULL, 0, 0)) {
      ...
      if (((msg.message == WM_SYSKEYDOWN) || (msg.message == WM_SYSKEYUP)) && (msg.wParam == VK_F10)) {
        /* DO NOTHING */
      } else {
...
static const char *vk_list[256] = {
    ...
    0, 0, "_", 0, 0, "VK_PROCESSKEY", /* 0xE5 */ /* Ctrl + F10, 全角半角? */
    0, 0,
